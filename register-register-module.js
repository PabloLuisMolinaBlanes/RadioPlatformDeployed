    ...
    register() {
        this.afauth.createUserWithEmailAndPassword(this.email, this.password).then(res => {
            this.afauth.signInWithEmailAndPassword(this.email, this.password).then(res => {
                ...
                let thisuser = new _user__WEBPACK_IMPORTED_MODULE_6__["User"](this.country, this.preferredFrequency, this.email, "online", false, res.user.uid, null, null, this.callsign);
