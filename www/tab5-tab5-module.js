...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<table>\r\n    <tr>\r\n        <th>Profile picture</th>\r\n        <th>Nombre</th>\r\n        <th>Callsign</th>\r\n        <th>Country</th>\r\n        <th>Status</th>\r\n        <th>Transmitting</th>\r\n        <th>Favourites</th>\r\n    </tr>\r\n    <tr *ngFor=\"let user of users\">\r\n        <td><img height=\"50px\" alt=\"Profile picture of user\" width=\"50px\" [src]=\"user.profilepicture\" *ngIf=\"user.profilepicture !== undefined\"><p *ngIf=\"user.profilepicture === undefined\">N/A</p></td>\r\n        <td>{{user.username}}</td>\r\n        <td>{{user.callsign}}</td>\r\n        <td>{{user.country}}</td>\r\n        <td>{{user.status}}</td>\r\n        <td>{{user.transmitting}} <span> ({{ user.transmittingFrequency }})</span></td>\r\n        <td>{{user.favouriteAntenna}} - {{user.favouriteRadioSet}}</td>\r\n</tr>\r\n</table>");
